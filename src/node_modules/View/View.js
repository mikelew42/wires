...
var View = module.exports = Mod2.extend({
	name: "View",
	tag: "div",
	capturable: true,
	active: true,
	...
	render_content: function(){
		...
		else if (this.content && is.fn(this.content.render))
			this.content.render();
		else
	...
	become_captor: function(){
		this.previous_captor = ViewCaptor.captor;
		ViewCaptor.captor = this;
	},
	restore_captor: function(){
		ViewCaptor.captor = this.previous_captor;
	},
