...
log.groupc("ExtendMfn2.js");

var ExtendMfn2 = module.exports = Mfn2.extend({
	name: "ExtendMfn2",
	main: function(Base, o){
		var Ext = Base.create_constructor(this.get_name(Base, o));
		this.setup_constructor(Ext, Base);
		this.create_prototype(Ext, Base);
		this.setup_prototype(Ext, Base, [].slice.call(arguments, 1));
	...
	create_prototype: function(Ext, Base){
		Ext.prototype = Object.create(Base.prototype);
			...
			Ext.prototype.assign({
				...
				proto: Object.create(Ext.prototype)
			});
	},
