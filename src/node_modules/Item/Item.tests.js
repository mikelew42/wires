...
var Item = require("./Item").extend({
	addClass: "wires"
});
	// console.log(View.prototype.$el.attr("class"))

var ExpandableItem = require("./ExpandableItem").extend({
	addClass: "wires"
});

var ExpandableItem2 = require("./ExpandableItem2");
...
test("Item", function(){
	...
	test("extend for default value?", function(){
		var Item2 = Item.extend({
			Value: "whatever"
		});

		// console.log(Item2.prototype.value);
...
test("ExpandableItem2", function(){

	View(function(){
		this.addClass("wires");

		var ei2 = ExpandableItem2({})
