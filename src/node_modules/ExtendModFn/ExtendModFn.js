...
// maybe add Ext.prototype.base = Object.create(Base.prototype);
// why another copy?
	// we will modify the Ext.prototype when overriding
	// we can then use this.base.whatever to access the old version, before we overrode it...
		// you might need to access this.constructor.prototype to get an interim value, if you've overridden it on .extend and .create
		// you could just do Ext.prototype.prototype = Ext.prototype...
		// then you could do this.prototype.whatever to access that interim version...
			// but, the prototype version will often be different...

	// this.base === (roughly, via Object.create()) this.constructor.base.prototype
	// this.prototype === this.constructor.prototype
		// this, too, could be separated via Object.create() for protection
		// doesn't protect against referential property modification, but.. the .base and .prototype property shouldn't ever be modified anyway...
